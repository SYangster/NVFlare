...
class WFCommServer(FLComponent, WFCommSpec):
    ...
    # def initialize_comm(self, fl_ctx: FLContext):
    #     engine = fl_ctx.get_engine()
    #     if not engine:
    #         self.system_panic(f"Engine not found. {self.__class__.__name__} exiting.", fl_ctx)
    #         return
    ...
    def _schedule_task(
        ...
        print("\t\n wf_comm_server starting _schedule_task")
        ...
        print("\t\n wf_comm_server middle _schedule_task")
        ...
        print("\t\n wf_comm_server after _schedule_task")
    ...
    def broadcast(
        ...
        """
        print("\t\n wf_comm_server starting broadcast")
    ...
    def broadcast_and_wait(
        ...
        """
        print("\t\n wf_comm_server starting broadcast_and_wait")
        self.broadcast(
            task=task,
            fl_ctx=fl_ctx,
            targets=targets,
