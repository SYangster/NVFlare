...
.. csv-table::
    ...
    configure_job_log,``configure_job_log job_id server config``,Configure the job log on the server.
    ...
    configure_site_log,``configure_job_log server config``,Configure the site log on the server.
